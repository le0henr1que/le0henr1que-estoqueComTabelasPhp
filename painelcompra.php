...
include_once('notifica_Compras.php');
?>
...
<body>
            ...
            <li>
                ...
                <td>
                    <?php
                                            ...
                                            if ($est >= 100 && $est <= 150) {
                                                if ($medida == 'Unidade') {
                                                    echo "<div class='alert alert-warning' role='alert'><center>Rever Estoque</center></div>";
                                                    $query_verificar = "SELECT * FROM notifica where nome_enviou = '$desc' ";
                                                    ...
                                                    if ($row_verificar > 0) {
                                                        ...
                                                        $query2 = "INSERT INTO notifica (Assunto, nome_enviou, quantidade, nivel, img ) values ('Rever Estoque ', '$desc', '$est', '', '1024px-OOjs_UI_icon_alert-destructive.svg.png')";
                                            ...
                                            if ($est >= 151) {
                                                if ($medida == 'Unidade') {
                                                    echo "<div class='alert alert-success' role='alert'><center>Estoque Completo</center></div>";
                                                    $query_verificar = "SELECT * FROM notifica where nome_enviou = '$desc' ";
                                                    $result_verificar = mysqli_query($conexao, $query_verificar);
                                                    $row_verificar = mysqli_num_rows($result_verificar);

                                                    if ($row_verificar > 0) {
                                                        $query2 = "DELETE FROM notifica  WHERE nome_enviou = '$desc' ";
                                                        $result2 = mysqli_query($conexao, $query2);
                                                    } else {
                                                        echo "";
                                                    }
                                            ...
                                            if ($est < 100) {
                                                if ($medida == 'Unidade') {
                                                    ...
                                                    echo "<div class='alert alert-danger' role='alert'><center>Comprar Urgente</center></div>";
                                                    $query_verificar = "SELECT * FROM notifica where nome_enviou = '$desc' ";
                                                    $result_verificar = mysqli_query($conexao, $query_verificar);
                                                    $row_verificar = mysqli_num_rows($result_verificar);
                                                    ...
                                                    if ($row_verificar > 0) {
                                                        ...
                                                        $query2 = "INSERT INTO notifica (Assunto, nome_enviou, quantidade, nivel, img ) values ('Comprar Urgentes', '$desc', '$est', '', '1024px-OOjs_UI_icon_alert-destructive.svg.png')";
                                                        $result2 = mysqli_query($conexao, $query2);
                                                    }
                                                }
                                            }
    ...
    <li>
        ...
        ?>
            ...
            <td> <a href="painelcompra.php?acao=notif&func=excluir&nome=<?php echo $nome_enviou; ?>&nivel=<?php echo $nivel; ?>" class="uk-icon-link"><span uk-icon="icon: close; ratio: 1"></a></span>
                <?php
                                        if (@$_GET['func'] == 'excluir') {

                                            $query = "DELETE FROM notifica where nome_enviou = '$nome_enviou' and  nivel = '$nivel' and Assunto = '$Assunto' ";
                                            $result = mysqli_query($conexao, $query);
                                            echo "<script language='javascript'>window.location='painelcompra.php'; </script>";
                                        }
